...
if respostaAllCompany.status_code == 200:
    ...
    for empresa in listaEmpresas:
        ...
        print(f"Empresa: {empresa_tradeName}, paga {empresa_value}")
        ...
        for titular in listaTitulares:
            ...
            for titular_agreement_value in titular_agreement:
                ...
                contagem_value_titular += titular_value
            print(f"O titular {titular_firstName} pertence a empresa {nome_empresa_titular} e paga {titular_value} ")
            ...
            for dependente in titular_dependents:
                ...
                for dependente_agreement_value in dependente_agreement:
                    ...
                    contagem_value_dependente += dependente_value
                print(f"O dependente: {dependente_firstName} pertence ao titular {titular_firstName} e paga {dependente_value}")
