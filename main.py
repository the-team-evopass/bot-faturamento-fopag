    ...
    for empresa in listaEmpresas:
        ...
        for grupo in listaGrupoEconomico:
            ...
            if grupo_billingType == 'UNIFICADO':
                for grupo_empresa in grupo['companies']:
                    grupo_empresa_cnpj = grupo_empresa['cnpj']
                    grupo_empresa_tradeName = grupo_empresa['tradeName']
                    if empresa_tradeName == grupo_empresa_tradeName:
                        valor_boleto_empresa += valor_boleto_empresa
                        valor_soma_total += valor_soma_total

            elif grupo_billingType == 'APARTADO':
                for grupo_empresa in grupo['companies']:
                    grupo_empresa_cnpj = grupo_empresa['cnpj']
                    grupo_empresa_tradeName = grupo_empresa['tradeName']
                    if empresa_tradeName == grupo_empresa_tradeName:
